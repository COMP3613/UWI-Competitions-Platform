...
def leaderboard_page():
    return render_template('leaderboard.html', leaderboard=display_rankings(),
                           user=current_user)  # , competitions=get_all_competitions(), moderators=get_all_moderators())
...
def init():
    ...
    with open("competitions.csv") as competition_file:
        ...
        for competition in reader:
            invoker.set_on_start(AddCompetition(competition['mod_name'], competition['comp_name'], competition['date'],
                                                competition['location'], competition['level'],
    ...
    with open("results.csv") as results_file:
        ...
        for result in reader:
            ...
            invoker.set_on_start(AddResults(result['mod_name'], result['comp_name'], result['team_name'], students,
                                            int(result['score'])))
            invoker.execute_command()
